<footer class="full-row bg-secondary p-0">
            <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-4">
                                    <div class="footer-widget mb-4">
                                        ...
                                        <p class="pb-20 text-white">"Welcome to PropertyDekho, your comprehensive real estate platform designed to simplify property search, buying, selling, and renting. Whether you're in pursuit of your dream home, exploring investment opportunities, or looking to list your property, PropertyDekho offers a user-friendly experience with extensive property listings, expert guidance, and seamless transaction support. Discover a diverse range of properties tailored to your preferences and benefit from our commitment to providing trusted and reliable service. Join us on your property journey and unlock the possibilities with PropertyDekho."</p>
                                        </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-lg-4">
                                            <div class="footer-widget">
                                                ...
                                                <ul class="text-white">
                                                    <li class="hover-text-primary"><i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>PropertyDekho,Goverdhan Chauraha, Mathura 281004, India</li>
                                                    <li class="hover-text-primary"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>9368407169</li>
													<li class="hover-text-primary"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>9058907203</li>
                                                <li class="hover-text-primary"><i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>helpline@propertydekho.com</li>
                                                </ul>
                                            </div>
                ...
                <div class="row copyright">
                    <div class="col-sm-6"> <span class="text-white">© 2024 PropertyDekho All right reserved</span> </div>
                    <div class="col-sm-6">
