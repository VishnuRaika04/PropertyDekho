                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Connect sellers with potential buyers to facilitate property sales efficiently.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Assist landlords in finding tenants and managing rental properties smoothly</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Provide a platform for property owners and agents to list and showcase their properties for sale or rent</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p> Offer guidance on legal aspects and investment opportunities in the real estate market</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="living-list pr-4">
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										<h5 class="mb-3">Extensive Property Selection</h5>
										<p>At PropertyDekho, we offer a vast selection of properties ranging from apartments and villas to bungalows and commercial spaces. Whether you're looking to buy, rent, or invest, our platform ensures you have access to a diverse range of options tailored to your needs and preferences. Discover your dream property effortlessly with our comprehensive listings.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>We prioritize user experience, providing an intuitive interface that allows for seamless navigation and effortless property search. Our advanced search filters and interactive maps make it simple to narrow down choices based on location, price, size, and amenities. Enjoy a hassle-free browsing experience that helps you find the perfect property with ease.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									<i class="flaticon-seller flat-medium float-left d-table mr-4 text-primary" aria-hidden="true"></i>
									<div class="pl-2">
										<h5 class="mb-3">Trusted and Reliable Services</h5>
										<p>PropertyDekho is backed by a team of real estate experts committed to delivering trusted and reliable service. Whether you're a seller, buyer, landlord, or tenant, our platform ensures you receive professional support at every step of your property journey. Benefit from expert guidance, legal advice, and personalized assistance to make informed decisions and achieve your real estate goals.</p>
									</div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Collaborate with experts and peers to gather insights and advice on property-related matters</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Easily manage and review essential documents and paperwork associated with property transactions</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Navigate the property acquisition process efficiently, from inquiries and negotiations to finalizing transactions</p>
                        </div>
                    </div>
                </div>
            </div>
